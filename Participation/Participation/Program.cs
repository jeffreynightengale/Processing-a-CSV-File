...
namespace Participation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] lines = File.ReadAllLines("sales_data_sample.csv"); //var instead of string[]
            ...
            for (int i = 1; i < sumMonths.Length; i++)
            {
                ...
                {
                    Console.WriteLine($"The sum for all Novemember's is {sumMonths[i].ToString("C")}");
                }
                else
                {
